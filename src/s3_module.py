...
class GoodReadsS3Module:
    ...
    def clean_bucket(self, bucket_name):
        """ Clean the provided bucket by deleting all the files present in the bucket"""
        logging.debug(f"Cleaning bucket : {bucket_name} by deleting all the files present in the bucket")
