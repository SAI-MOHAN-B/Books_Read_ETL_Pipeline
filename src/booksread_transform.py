...
class GoodreadsTransform:
    ...
    def transform_reviews_dataset(self):
        ...
        deduped_reviews_df = deduped_reviews_df.withColumn('review_added_date',goodreads_udf.stringtodatetime('review_added_date'))\
