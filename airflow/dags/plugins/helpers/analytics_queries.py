class AnalyticsQueries:
    ...
    create_schema = """CREATE SCHEMA IF NOT EXISTS bookreads_warehouse;"""

    create_author_reviews = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.popular_authors_review_count
        (
    ...
    create_author_rating = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.popular_authors_average_rating
        (
            author_id BIGINT PRIMARY KEY DISTKEY,
    ...
    create_best_authors = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.best_authors
        (
            author_id BIGINT PRIMARY KEY DISTKEY,
            review_count BIGINT,
            average_review_rating FLOAT,
    ...
    populate_authors_reviews = """
        INSERT INTO bookreads_warehouse.popular_authors_review_count
    ...
    populate_authors_ratings = """
        INSERT INTO bookreads_warehouse.popular_authors_average_rating
    ...
    populate_best_authors = """
        INSERT INTO bookreads_warehouse.best_authors
        ...
        FROM bookreads_warehouse.popular_authors_average_rating ar
        INNER JOIN
        bookreads_warehouse.popular_authors_review_count rc
    ...
    create_book_reviews = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.popular_books_review_count
        (
    ...
    create_book_rating = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.popular_books_average_rating
        (
            book_id BIGINT PRIMARY KEY,
    ...
    create_best_books = """
        CREATE TABLE IF NOT EXISTS bookreads_warehouse.best_books
        (
            book_id BIGINT PRIMARY KEY,
    ...
    populate_books_reviews = """
        INSERT INTO bookreads_warehouse.popular_books_review_count
    ...
    populate_books_ratings = """
        INSERT INTO bookreads_warehouse.popular_books_average_rating
    ...
    populate_best_books = """
        INSERT INTO bookreads_warehouse.best_books
        ...
        FROM bookreads_warehouse.popular_books_average_rating ar
        INNER JOIN
        bookreads_warehouse.popular_books_review_count rc
